package com.shanlin.camera.cameraclient.ui.fragment.third;
 ...
 */
public class CameraInfoFragment extends BaseLazyMainFragment {

    public static CameraInfoFragment newInstance() {
