...
import com.shanlin.camera.cameraclient.adapter.LivePlayChannelAdapter;
 ...
 */
public class LivePlayChannelFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private LivePlayChannelAdapter mAdapter;
    ...
    public static LivePlayChannelFragment newInstance() {

        Bundle args = new Bundle();

        LivePlayChannelFragment fragment = new LivePlayChannelFragment();
    ...
    private void initView(View view) {
        ...
        mAdapter = new LivePlayChannelAdapter(_mActivity);
...
//        });
    ...
    List<LivePlayChannelInfo> infos;
    private List<LivePlayChannelInfo> getTestList(){
        if( infos == null) {
            infos = new ArrayList<>(15);
            LivePlayChannelInfo item;
            ...
            for (int i = 0; i < 15; i++) {
                item = new LivePlayChannelInfo();
                item.setTitle(i + "个设备");
                item.setImg(mImgRes[i % 5]);
