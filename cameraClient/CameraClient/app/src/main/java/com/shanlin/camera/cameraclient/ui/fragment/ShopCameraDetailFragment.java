 ...
 */
public class ShopCameraDetailFragment extends BaseBackFragment {
    ...
    public static ShopCameraDetailFragment newInstance(int number) {
        ShopCameraDetailFragment fragment = new ShopCameraDetailFragment();
    ...
    private void initView(View view) {
        ...
        mBtnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                start(ShopCameraDetailFragment.newInstance(mNumber + 1));
            }
        });
        mBtnNextWithFinish.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startWithPop(ShopCameraDetailFragment.newInstance(mNumber + 1));
            }
        });
    }
}
