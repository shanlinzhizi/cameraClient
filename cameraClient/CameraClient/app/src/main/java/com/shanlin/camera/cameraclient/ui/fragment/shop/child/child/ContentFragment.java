package com.shanlin.camera.cameraclient.ui.fragment.shop.child.child;
        ...
        mBtnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (getParentFragment() instanceof ShopFragment) {
                    ((ShopFragment) getParentFragment()).start(ShopCameraDetailFragment.newInstance(1));
                }
            }
        });

        mImg = (ImageView) view.findViewById(R.id.img_camera);
        int index = new Random().nextInt(10);
        mImg.setImageResource(imgRes[index % 5]);
    }
